sap.ui.define([
		...
		return BaseObject.extend("example.es6.ZES6_MASTER_DETAIL_TEMPLATE.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias example.es6.ZES6_MASTER_DETAIL_TEMPLATE.controller.ListSelector
			 */
